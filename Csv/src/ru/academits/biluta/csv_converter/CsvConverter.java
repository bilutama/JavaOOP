...
public class CsvConverter {
    ...
    public static void printHelpMessage() {
        ...
        System.out.printf("\tru.academits.biluta.CsvConverter.CsvConverter - converting csv into html-table.%n%n");

        System.out.printf("SYNOPSIS%n");
        System.out.printf("\tru.academits.biluta.CsvConverter.CsvConverter [input_filename] [output_filename]%n%n");
