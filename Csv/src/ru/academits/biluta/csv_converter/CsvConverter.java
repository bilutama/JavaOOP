...
public class CsvConverter {
    public static void convertCsvToHtmlTable(String inputFileName, String outputFileName) throws FileNotFoundException {
        try (
            ...
            while (scanner.hasNextLine()) {
                String processedString = scanner.nextLine();
                int currentCharIndex = 0;

                while (currentCharIndex < processedString.length()) {
                    char currentChar = processedString.charAt(currentCharIndex);
                    char nextChar = (currentCharIndex < processedString.length() - 1) ? processedString.charAt(currentCharIndex + 1) : END_OF_LINE;
